...
from .extensions import cors, rest_api, db
from . import views, commands
from config.settings import SETTINGS
from server.flaskutils import init_logging
...
def register_blueprints(app):
    ...
    # app.register_blueprint(andon.blueprint)
    # app.register_blueprint(mobile_app.blueprint)
